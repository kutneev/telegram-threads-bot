...
def generate_threads_posts(topic):
    try:
        ...
        prompt = f"Представь, что ты создаешь вирусные посты для соцсети Threads по заданной теме. Тема: {topic}. Схема такая - придумываешь вопрос или тему для обсуждения и накидываешь свои 2 комментария для начала обсуждения. Например, тема: Сон. Вопрос: Как вам удается высыпаться? Делитесь лайфхаками. / Комментарий 1: Я убираю телефон за 1 час до сна. / Комментарий 2: Ложусь и встаю в одно и то же время. "
